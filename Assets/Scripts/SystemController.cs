...
public class SystemController : MonoBehaviour
{
    ...
    private Save CreateSaveGameObject()
    {
        ...
        save.rotatorSpeed = Data.Instance.rotatorSpeed;
        save.pinSpeed = Data.Instance.pinSpeed;
    ...
    public void LoadGame()
    {
        if (File.Exists(Application.persistentDataPath + "/gamesave.save"))
        {
            ...
            Data.Instance.pinSpeed = save.pinSpeed;
            Data.Instance.rotatorSpeed = save.rotatorSpeed;
